...
public class CityDaoImpl implements CityDao {
    ...
    public void insert(History history) {
        String sql = "insert into travels (passenger, dep, arr, date, class, seat, "
                + "flight_no, email, gender, passport, phone) values(?,?,?,?,?,?,?,?,?,?,?)";
        try {
    ...
    public List<History> getList() {
        ...
        try {
            ...
            while (rs.next()) {
                History history = new History(rs.getInt("serial"), rs.getString("passenger"), 
                        rs.getString("dep"), rs.getString("arr"), rs.getString("date"), 
                        rs.getString("class"), rs.getString("seat"), rs.getString("flight_no"), 
                        rs.getString("email"), rs.getString("gender"), rs.getString("passport"), rs.getString("phone"));
                list.add(history);
            }
    ...
    public List<History> seatMod() {
        ...
        try {
            ...
            while (rs.next()) {
                History historyForSeat = new History(rs.getString("date"), rs.getString("dep"), 
                        rs.getString("arr"), rs.getString("seat"));
